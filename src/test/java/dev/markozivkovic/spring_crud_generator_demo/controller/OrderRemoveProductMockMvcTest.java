...
class OrderRemoveProductMockMvcTest {
    ...
    @Test
    void ordersIdProductsDelete() throws Exception {

        final Long orderId = Instancio.create(Long.class);

        this.mockMvc.perform(delete("/api/v1/orders/{id}/products", orderId))
    ...
    @Test
    void ordersIdProductsDelete_invalidOrderIdFormat() throws Exception {
