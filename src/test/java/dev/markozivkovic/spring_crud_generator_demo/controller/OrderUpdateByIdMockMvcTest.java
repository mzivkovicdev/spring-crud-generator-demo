...
class OrderUpdateByIdMockMvcTest {
    ...
    @Test
    void ordersIdPut() throws Exception {
        ...
        verify(this.orderService).updateById(orderId, body.getQuantity());
    }

    @Test
    void ordersIdPut_invalidOrderIdFormat() throws Exception {
    ...
    @Test
    void ordersIdPut_noRequestBody() throws Exception {
