...
class ProductAddUserMockMvcTest {
    ...
    @Test
    void productsIdUsersPost() throws Exception {
        ...
        verify(this.productBusinessService).addUsers(id, body.getUserId());
    }

    @Test
    void productsIdUsersPost_invalidIdFormat() throws Exception {
    ...
    @Test
    void productsIdUsersPost_noRequestBody() throws Exception {
