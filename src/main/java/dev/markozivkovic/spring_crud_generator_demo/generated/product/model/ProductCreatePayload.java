...
public class ProductCreatePayload {
  ...
  public ProductCreatePayload name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductCreatePayload price(@Nullable String price) {
    this.price = price;
    return this;
  }
  ...
  public ProductCreatePayload uuid(@Nullable UUID uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public ProductCreatePayload birthDate(@Nullable LocalDate birthDate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, productCreatePayload.name) &&
        ...
        Objects.equals(this.birthDate, productCreatePayload.birthDate) &&
        Objects.equals(this.status, productCreatePayload.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, price, users, uuid, birthDate, status);
  }
