...
public record ProductUpdateTO(@NotNull @NotNull @Size(min = 10, max = 100) @NotBlank String name, @NotNull @NotNull @Min(1) @Max(100) Integer price, @NotNull @NotNull UUID uuid, LocalDate releaseDate, List<ProductDetailsTO> details, StatusEnum status) {
